...
void boleta_archivo(int position){
    ...
    outfile<<"Nombre,Apellido,Email,Genero,Matematicas,Sociales,Biologia,Fisica,Educacion Fisica,Artes"<<endl;
    outfile<<datos_est[position].nombre<<","<<datos_est[position].apellido<<","<<datos_est[position].email<<","<<datos_est[position].genero<<","<<datos_est[position].math<<","<<datos_est[position].sociales<<","<<datos_est[position].biologia<<","<<datos_est[position].fisica<<","<<datos_est[position].EF<<","<<datos_est[position].artes<<endl;
    outfile.close();
}
...
void hacer_boleta(){
    ...
    cout<<left<<setw(19)<<"Fisica: "<<datos_est[position].fisica<<endl;
